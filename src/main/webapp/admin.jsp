                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <form action="/controller" method="post">
                            <input class="dropdown-item" value="activity_name" name="name" type="submit"/>
                            <input type="hidden" name="command" value="sort_by"/>
                        </form>
                        <form action="/controller" method="post">
                            <input class="dropdown-item" value="category_name" name="name" type="submit"/>
                            <input type="hidden" name="command" value="sort_by"/>
                        </form>
                        <form action="/controller" method="post">
                            <input class="dropdown-item" value="users_number" name="name" type="submit"/>
                            <input type="hidden" name="command" value="sort_by"/>
                        </form>
                    </div>
                </li>
    ...
    <table border="1" class="table table-striped table-bordered">
        ...
        <c:forEach items="${sessionScope.activities_list}" var="list">
            <tr>
                ...
                <td><%= TimeLogDao.getQuantityPerActivityAndStatus(Integer.valueOf(lst.get(2)), 0)%>
                </td>
                <td>
                    <form method="post" action="controller">
                        ...
                        <input type="hidden" value="view_unapproved" name="command"/>
